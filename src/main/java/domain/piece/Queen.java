...
public class Queen extends ChessPiece {
    ...
    public Queen(final Team team, final Name name) {
        super(team, name);
    }
    ...
    private boolean isCorrectMovement(final int rowDistance, final int columnDistance) {
        int absoluteRowDistance = Math.abs(rowDistance);
        int absoluteColumnDistance = Math.abs(columnDistance);
        return (absoluteRowDistance == absoluteColumnDistance) ||
                absoluteRowDistance == ZERO || absoluteColumnDistance == ZERO;
    }
}
